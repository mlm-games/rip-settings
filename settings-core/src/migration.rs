...
mod tests {
    ...
    #[test]
    fn test_key_rename() {
        let mut data = serde_json::json!({"old_name": "hello", "other": 42});
    ...
    fn test_custom_migration() {
        let mut data = serde_json::json!({"font_size": 14});
    ...
    fn test_migration_chain_validation() {
        let _manager = MigrationManager::new(3)
            .add_key_rename(2, 3, "old", "new")
            .add_key_rename(0, 1, "other", "other_new");
    }
}
